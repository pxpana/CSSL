...
class DataManager(object):
    ...
    def get_dataset(
        self, indices, source, mode, appendent=None, ret_data=False, m_rate=None, pretrain_transform=None
    ):
        if source == "train":
        ...
        if ret_data:
            ...
            pretrain_train_dataset = PretrainDataset(data=data, transform=pretrain_transform)
            classifier_train_dataset = DummyDataset(data, targets, trsf, self.use_path)
            return pretrain_train_dataset, classifier_train_dataset
